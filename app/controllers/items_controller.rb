class ItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @item.save
        format.html { redirect_to @item, notice: 'El artículo fue creado exitosamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @item.update(item_params)
        format.html { redirect_to @item, notice: 'El artículo se actualizó correctamente.' }
  ...
  def destroy
    @item.destroy
    respond_to do |format|
      format.html { redirect_to items_url, notice: 'El artículo fue destruido con éxito.' }
  ...
  def addsubscription
    ...
    respond_to do |format|
      if subscr_item.save
        format.html { redirect_to @item, notice: 'Suscrito a alerta. Le notificaremos cuando el artículo esté disponible.' }
        format.json { render :show, status: :ok, location: @item }
      else
        format.html { render :edit }
        format.json { render json: @item.errors, status: :unprocessable_entity }
