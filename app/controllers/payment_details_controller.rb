class PaymentDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_detail.save
        format.html { redirect_to session.delete(:return_to), notice: 'El detalle del pago se creó correctamente.' }
  ...
  def update
    respond_to do |format|
      if @payment_detail.update(payment_detail_params)
        format.html { redirect_to session.delete(:return_to), notice: 'El detalle del pago se actualizó correctamente.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to payment_details_url, notice: 'El detalle del pago fue destruido con éxito.' }
